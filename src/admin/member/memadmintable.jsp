...
<body style="margin:10px;">	
	...
	<tr>
		...
		<td><img src="${m.getM_image()}" width="30px" height="30px"/>&nbsp;&nbsp;<a href="viewmemberadminImage.jsp?member_id=${m.getMember_id()}">View Image</a></td>
		<td>${m.getF_name()}</td>
		<td>${m.getM_name()}</td>
		<td>${m.getL_name()}</td>
		<td>${m.getBdate()}</td>
		...
		<td><a href="memberadmindelete.jsp?member_id=${m.getMember_id()}">Delete</a></td>
	</tr>
	</c:forEach>
	</tbody>
	</table>
	<a class="btn btn-dark" href="../../addmemberadminform.jsp">Add another</a>
</body>
</html>