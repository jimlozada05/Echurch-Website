...
@WebServlet("/uploademployeeadminImage")
@MultipartConfig(maxFileSize = 16177216)//1.5mb
public class uploademployeeadminImage extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	PrintWriter out;
	
    public uploademployeeadminImage() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (part != null) {
            try {
                ...
                PreparedStatement ps = con.prepareStatement("insert into employee(position,ee_image,login_id,f_name,m_name,l_name,bdate,contact,age,gender,maritalstatus,email,cityaddress,provinceaddress) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
