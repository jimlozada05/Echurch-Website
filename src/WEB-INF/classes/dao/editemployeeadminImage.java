...
/**
 * Servlet implementation class editemployeeadminImage
 */
@WebServlet("/editemployeeadminImage")
@MultipartConfig(maxFileSize = 16177216)//1.5mb
public class editemployeeadminImage extends HttpServlet {
	private static final long serialVersionUID = 1L;
	PrintWriter out;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public editemployeeadminImage() {
        super();
