	        ...
	        <nav class="navbar navbar-default navbar-fixed">
	            <div class="container-fluid">
	                <div class="navbar-header">
	                    ...
	                    <a class="navbar-brand" href="#">Employee > Edit Profile</a>
	                </div>
		 ...
		 <div class="row">
                        ...
                        <div class="card card-user">
                            ...
                            <div class="text-center">
                                <div class="box">
									<label><a href="editemployeeadminimageform.jsp?employee_id=<%=ee.getEmployee_id()%>"><i class="pe-7s-camera"></i> <span>Change Profile&hellip;</span></a></label>
								</div>
