	...
	%>	
		...
		<div id="pop1">
			...
			<div>
				...
				<jsp:include page="employee/viewemployeeImage.jsp?employee_id=${ee.getEmployee_id()}"></jsp:include>
		...
		<div id="pop2">
			...
			<div>
				...
				<jsp:include page="../editemployeeimageform.jsp?employee_id=${ee.getEmployee_id()}"></jsp:include>
			</div>
		</div>
		<div id="pop3">
			<span class="helper"></span>
			<div>
				...
				<jsp:include page="../editemployeeform.jsp?employee_id=${ee.getEmployee_id()}"></jsp:include>
			</div>
		</div>
	</c:forEach>
<div id="mySidenav" class="sidenav">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  <a href="#" class="tablink" onclick="openPage('profilecon', this, 'white')" id="defaultOpen"><i class="far fa-user">&nbsp;Profile</i></a>
  <a href="indexmessagesemployee.jsp?login_id=<%out.print(sessionLogin_id);%>" class="tablink" onclick="openPage('messengercon', this, 'white')"><i class="far fa-comments">&nbsp;Messages</i></a>
	...
	<div id="main">
		<div id="content">
			<main>
				<c:forEach items="${list}" var="ee">
				<span id="profilepic">
				<img src="employee/getemployeeImage.jsp?employee_id=${ee.getEmployee_id()}" height="150px" width="150px" style="border-radius:80px;" onclick="document.getElementById('pop1').style.display='block'"/>
				<br>
				<p></p>
				<p style="font-size:20px;">${ee.getL_name()}&nbsp;&comma;${ee.getF_name()}&nbsp;
				<%
					try{
					Connection conn=dbconnect.getConnection();
					PreparedStatement ps= conn.prepareStatement("SELECT m_name FROM employee where login_id="+sessionLogin_id+"");
				...
				%>
				<p style="color:gray;font-size:12px;">${ee.getCityaddress()}&comma;${ee.getProvinceaddress()}</p>
				</span>
				<hr>
				<ul class="list-groupnb">
				  <li class="list-group-itemnb"><label>Email: </label> <br>&emsp;<label>${ee.getEmail()}</label></li>			
				  <li class="list-group-itemnb"><label>Birth day: </label> <br>&emsp;<label>${ee.getBdate()}</label></li>
				  <li class="list-group-itemnb"><label>Age: </label> <br>&emsp;<label>${ee.getAge()}</label></li>
				  <li class="list-group-itemnb"><label>Gender: </label> <br>&emsp;<label>${ee.getGender()}</label></li>
				  <li class="list-group-itemnb"><label>Marital status: </label> <br>&emsp;<label>${ee.getMaritalstatus()}</label></li>
				  <li class="list-group-itemnb"><label>Position: </label> <br>&emsp;<label>${ee.getPosition()}</label></li>
				  <li class="list-group-itemnb"><label>Contact information: </label> <br>&emsp;<label>${ee.getContact()}</label></li>
