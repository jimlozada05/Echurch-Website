...
<div id="mySidenav" class="sidenav">
  ...
  <a href="indexprofileemployee.jsp" onclick="openPage('profilecon', this, 'white')" id="defaultOpen"><i class="far fa-user">&nbsp;Profile</i></a>
							...
							//take the data from text area
								...
								$.ajax({
									...
									success: function(data) {
										...
										top.location.href ="indexmessagesemployee.jsp?user="+ user + "&login_id=${param.login_id}";
									}
								});
						});
			...
			<div id="left-col">
				...
				try{
					...
					while(rs.next()){
						...
						<%out.print("<a href='indexmessagesemployee.jsp?user="+receiver_name+"&login_id="+sessionLogin_id+"'>"+receiver_name+"</a>");%>
						</div>
							<%
							...
							<div class="gray-back">
							<img src="utility/pics/messenger.png" class="image">
							<%out.print("<a href='indexmessagesemployee.jsp?user="+sender_name+"&login_id="+sessionLogin_id+"'>"+sender_name+"</a>");%>
							</div>
								<%
			...
			<div id="right-col-container">
					...
					try{
						...
						while(rs.next()){
							...
							if(send_name.equals(sender_name)){
								response.sendRedirect("indexmessagesemployee.jsp?user="+receiver_name+"&login_id="+sessionLogin_id+"");
							}
							else
								response.sendRedirect("indexmessagesemployee.jsp?user="+sender_name+"&login_id="+sessionLogin_id+"");
							}
					}
					catch(Exception e){
					}
